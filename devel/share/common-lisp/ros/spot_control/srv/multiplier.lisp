...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name spot_control-srv:<multiplier-request> is deprecated: use spot_control-srv:multiplier-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <multiplier-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spot_control-srv:a-val is deprecated.  Use spot_control-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <multiplier-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spot_control-srv:b-val is deprecated.  Use spot_control-srv:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<multiplier-request>)))
  ...
  "spot_control/multiplierRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'multiplier-request)))
  "Returns string type for a service object of type 'multiplier-request"
  "spot_control/multiplierRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name spot_control-srv:<multiplier-response> is deprecated: use spot_control-srv:multiplier-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <multiplier-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader spot_control-srv:result-val is deprecated.  Use spot_control-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<multiplier-response>)))
  ...
  "spot_control/multiplierResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'multiplier-response)))
  "Returns string type for a service object of type 'multiplier-response"
  "spot_control/multiplierResponse")
