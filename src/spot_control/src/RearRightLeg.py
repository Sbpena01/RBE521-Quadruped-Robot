...
def setJoints():
    ...
    shoulder_pub = rospy.Publisher('/spotmicroai/rear_right_shoulder_position_controller/command',
                                   Float64, queue_size=10)
    leg_pub = rospy.Publisher('/spotmicroai/rear_right_leg_position_controller/command',
                              Float64, queue_size=10)
...
if __name__ == '__main__':
    try:
        rospy.init_node("rear_right_leg_joints", anonymous=True)
        rospy.loginfo('Running joint controller for rear right leg')
